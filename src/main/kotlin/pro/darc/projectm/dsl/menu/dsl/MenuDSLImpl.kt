package pro.darc.projectm.dsl.menu.dsl
...
import pro.darc.projectm.dsl.menu.*
import pro.darc.projectm.dsl.menu.dsl.slot.SlotDSL
import pro.darc.projectm.dsl.menu.dsl.slot.SlotDSLImpl
import pro.darc.projectm.dsl.menu.dsl.slot.SlotEventHandlerDSL
import pro.darc.projectm.dsl.menu.slot.MenuPlayerSlotRender
import pro.darc.projectm.dsl.menu.slot.MenuPlayerSlotUpdate
...
class MenuDSLImpl(
    ...
    private fun setNewTask() {
        task = ProjectMCoreMain.instance.task(repeatDelay = updateDelay) { update() }
    }
