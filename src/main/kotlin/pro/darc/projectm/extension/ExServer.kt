...
val ticksPerAnimalSpawns: Int get() = server.getTicksPerSpawns(SpawnCategory.ANIMAL)
val ticksPerMonsterSpawns: Int get() = server.getTicksPerSpawns(SpawnCategory.MONSTER)
