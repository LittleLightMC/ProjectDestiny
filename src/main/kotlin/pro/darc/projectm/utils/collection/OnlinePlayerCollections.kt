package pro.darc.projectm.utils.collection
...
import pro.darc.projectm.extension.KListener
import pro.darc.projectm.extension.event
import pro.darc.projectm.extension.registerEvents
import pro.darc.projectm.extension.unregisterListener
import java.util.*
...
class OnlinePlayerList() : LinkedList<Player>(), OnlinePlayerCollection, Plugin by ProjectMCoreMain.instance {
